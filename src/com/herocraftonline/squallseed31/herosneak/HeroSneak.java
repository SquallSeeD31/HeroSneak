...
{
	public ArrayList<Player> sneakingPlayers = new ArrayList<Player>();
	public static Timer refreshTimer = null;
	...
	public String sneakOnMessage;
	public String sneakOffMessage;
	public String permissionSystem;
	public int refreshInterval;
	public boolean opsAutoSneak;
	public List<String> canAutosneak;
	public List<String> canSneak;
  ...
  public void onEnable()
  {
	    ...
	    pm.registerEvent(Event.Type.PLAYER_QUIT, this.listener, Event.Priority.Monitor, this);
	    pm.registerEvent(Event.Type.PLAYER_JOIN, this.listener, Event.Priority.Monitor, this);
	    try {
	        pm.registerEvent(Event.Type.PLAYER_TOGGLE_SNEAK, this.listener, Event.Priority.Highest, this);
	        pm.registerEvent(Event.Type.PLAYER_RESPAWN, this.listener, Event.Priority.Highest, this);
